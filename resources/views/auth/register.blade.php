...
<div class="bg-white p-8 rounded-2xl shadow-xl w-96">
    <h2 class="text-2xl font-bold mb-6 text-center text-orange-600">Đăng ký</h2>
    ...
    <form action="{{ route('register') }}" method="POST">
        ...
        <div class="mb-4">
            <input type="text" name="name" value="{{ old('name') }}" placeholder="Tên" required
                class="w-full p-3 border rounded-lg focus:ring-2 focus:ring-orange-400 outline-none @error('name') border-red-500 @enderror">
            @error('name')
    ...
    <p class="text-sm mt-4 text-center">
        Đã có tài khoản?
        <a href="{{ route('login') }}" class="text-orange-500 hover:underline">Đăng nhập</a>
    </p>
